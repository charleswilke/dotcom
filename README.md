...
- **Graphics**: Canvas 2D and procedural drawing, so the games ship with zero image assets, on purpose
...
The **code** here is MIT licensed, so take it and go build something. The **music, art, lyrics, and writing** are not: those stay all rights reserved. See [LICENSE](LICENSE) for the specifics.
