...
drone, the weaver, Karen, the bomber, their deaths and the background sky (a
multiplane of cut stars, torn nebula sheets and flat planets) now use the same
cut-paper treatment (`PAPER GAMEPLAY SAMPLE` section in
