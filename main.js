...
function initGWORLightbox() {
    ...
    const tracks = [
        ...
        { title: 'Refuse the Frequency', file: 'audio/grief-without-ritual/refuse-the-frequency.mp3', video: 'audio/grief-without-ritual/refuse-the-frequency.mp4', article: 'https://charleswilke.substack.com/p/salve-for-the-algorithmic-rash' },
