...
function initTimeDial() {
    ...
    let currentStation = 12; // Start at station 12 (May '26)
...
function initJCLightbox() {
    const tracks = [
        ...
        { title: 'Refuse the Frequency', file: 'audio/junkyard-cabaret/refuse-the-frequency.mp3', cover: 'audio/junkyard-cabaret/refuse-the-frequency-title.webp?v=202606142108', article: 'https://charleswilke.substack.com/p/salve-for-the-algorithmic-rash' },
