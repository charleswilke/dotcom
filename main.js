...
function initHeaderGlitchEffects() {
    ...
    signal.style.setProperty('--wordmark-art', `url("${artwork.getAttribute('src')}")`);
...
function initJCLightbox() {
    const tracks = [
        { title: 'Why This Way', act: 'Act I', file: '/audio/junkyard-cabaret/why-this-way.mp3?v=202609191600', cover: '/audio/junkyard-cabaret/why-this-way-title.webp?v=202606071656', article: 'https://charleswilke.substack.com/p/the-narrower-path' },
